/**
 * Execution search/scope — deterministic filtering and sorting over the post-trade execution records.
 * Pure: no IO. Powers the Execution Cost Explorer's filters.
 */
