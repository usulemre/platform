/**
 * Synthetic in-memory seed for development and tests. Backtest METADATA ONLY — no
 * simulation, no performance-metric computation, no optimization, no persistence.
 * Datasets/features/signals/experiments/portfolios are referenced by ref so
 * cross-links resolve; metric VALUES are inert strings, nothing is computed.
 */
import type { Backtest, BacktestComparison, BacktestFamily } from '@platform/backtesting-sdk';

export const BACKTESTS: readonly Backtest[] = [
  {
    id: 'BT-REVERSAL',
...
export const FAMILIES: readonly BacktestFamily[] = [
  {
    namespace: 'equities',
    family: 'reversal',
...
export const COMPARISONS: readonly BacktestComparison[] = [
  {
    id: 'CMP-1',
