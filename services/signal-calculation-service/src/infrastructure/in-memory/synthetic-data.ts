 ...
 * mock DATA, not mock generation: the engine runs the REAL SDK signal generators over these bars.
 * Dataset refs/seeds match the Feature Calculation Engine's canonical synthetic datasets.
 */
import { toOhlcvSeries, type OhlcvBar, type OhlcvSeries } from '@platform/signal-calculation-sdk';
