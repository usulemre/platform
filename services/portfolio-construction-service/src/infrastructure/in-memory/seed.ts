/**
 * Synthetic in-memory seed for development and tests. Portfolio METADATA ONLY — no
 * optimization, no weight calculation, no risk computation, no persistence.
 * Signals/strategies/features/datasets/backtests/experiments are referenced by ref
 * so cross-links resolve; target weights, constraint bounds and metric VALUES are
 * inert strings, nothing is computed.
 */
import type {
  Portfolio,
  PortfolioComparison,
...
export const FAMILIES: readonly PortfolioFamily[] = [
  {
    namespace: 'equities',
    family: 'market-neutral',
...
export const TEMPLATES: readonly PortfolioTemplate[] = [
  {
...
export const COMPARISONS: readonly PortfolioComparison[] = [
  {
    id: 'PCMP-1',
