/**
 * Synthetic in-memory seed for development and tests. Signal METADATA ONLY — no
 * alpha models, no signal calculations, no statistics, no ML, no persistence.
 * Features/datasets/signals are referenced by ref so cross-links resolve; nothing
 * is computed.
 */
import type { RegisteredSignal, SignalFamily } from '@platform/signal-sdk';
import type { SignalCandidate } from '../ports';

export const SIGNALS: readonly RegisteredSignal[] = [
  {
    id: 'SG-REVERSAL',
...
export const FAMILIES: readonly SignalFamily[] = [
  {
    namespace: 'equities',
    family: 'reversal',
...
export const SIGNAL_CANDIDATES: readonly SignalCandidate[] = [
  { ref: 'cand-earnings-drift', name: 'Post-earnings drift', source: 'RESEARCH' },
  { ref: 'cand-flow-imbalance', name: 'Order-flow imbalance', source: 'FEATURE_DISCOVERY' },
];
