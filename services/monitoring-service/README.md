...
Host independent production monitoring, drift and research-to-production parity monitors, cost attribution, and halt integration. Narrates; the risk engine decides halts.
...
Execution Layer and Observability Spine (Architecture V2 §5.9/§5.10) — implemented in Phase 8 (Implementation Roadmap, Part C).

## Dependencies

execution-service; risk-service (halt); the run ledger. Dependencies flow inward toward stable contracts only (IMP-12, AV2-13); direct
cross-layer access to internals and circular dependencies are PROHIBITED.

## Related Governance Documents

CLAUDE.md; Architecture V2; Implementation Roadmap; Production Monitoring Governance; Incident Response Governance; P3-15, P5-06.
