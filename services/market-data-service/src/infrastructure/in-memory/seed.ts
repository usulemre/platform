/**
 * Synthetic in-memory seed for development and tests. Canonical METADATA ONLY —
 * no real market data, no provider fields, no secrets. Datasets reference the
 * canonical datasets produced by the Data Ingestion Pipeline via `ingestionRef`.
 */
import type {
  Asset,
  Dataset,
...
export const TIME_SERIES: readonly TimeSeriesRef[] = [
  {
...
export const SESSIONS: readonly TradingSession[] = [
  {
    id: 'TS-BINANCE',
    exchangeId: 'EX-BINANCE',
    name: 'Continuous',
