# AGT-RD-004 · Research Director (proposer)

> **Phase 0 scaffolding placeholder.** Not implemented — agents are built in **Phase 5**.

## Purpose

Registered agent **Research Director (proposer)**. Authoritative spec: its Tier-4 Agent Contract. Existence/status:
the AI Agent Registry entry `AGT-RD-004`.

## Governance Summary (from the AI Agent Registry — the registry/contract govern)

- **Authority:** propose (never `decide`, AGC-9 / REG-9).
- **Trust level:** T2.
- **Owner:** HQ.
- **Workflow participation:** orchestration.
...
CLAUDE.md (AI-1..8, AG-1..4); Architecture V2 §5.3; RB-15 · AIGOV; AI Agent Registry (AGT-RD-004);
