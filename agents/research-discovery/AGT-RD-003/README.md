# AGT-RD-003 · Company Researcher

> **Phase 0 scaffolding placeholder.** Not implemented — agents are built in **Phase 5**.

## Purpose

Registered agent **Company Researcher**. Authoritative spec: its Tier-4 Agent Contract. Existence/status:
the AI Agent Registry entry `AGT-RD-003`.
...
CLAUDE.md (AI-1..8, AG-1..4); Architecture V2 §5.3; RB-15 · AIGOV; AI Agent Registry (AGT-RD-003);
