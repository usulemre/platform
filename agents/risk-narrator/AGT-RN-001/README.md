...
Registered agent **Risk Analysis Agent**. Authoritative spec: its Tier-4 Agent Contract. Existence/status:
the AI Agent Registry entry `AGT-RN-001`.

## Governance Summary (from the AI Agent Registry — the registry/contract govern)

- **Authority:** narrate (never `decide`, AGC-9 / REG-9).
- **Trust level:** T2.
- **Owner:** HPR.
- **Workflow participation:** WFC-47.
...
CLAUDE.md (AI-1..8, AG-1..4); Architecture V2 §5.3; RB-15 · AIGOV; AI Agent Registry (AGT-RN-001);
