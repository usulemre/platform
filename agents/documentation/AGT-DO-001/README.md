...
Registered agent **Documentation Agent**. Authoritative spec: its Tier-4 Agent Contract. Existence/status:
the AI Agent Registry entry `AGT-DO-001`.
...
- **Trust level:** T2.
- **Owner:** PE.
- **Workflow participation:** all workflows.
...
CLAUDE.md (AI-1..8, AG-1..4); Architecture V2 §5.3; RB-15 · AIGOV; AI Agent Registry (AGT-DO-001);
