# agents/portfolio-narrator — Portfolio (analysis / narrator) agents
...
Registry category directory for **Portfolio (analysis / narrator)** agents. Each sub-directory is one
