...
Registered agent **Validation Narrator**. Authoritative spec: its Tier-4 Agent Contract. Existence/status:
the AI Agent Registry entry `AGT-VN-001`.
...
CLAUDE.md (AI-1..8, AG-1..4); Architecture V2 §5.3; RB-15 · AIGOV; AI Agent Registry (AGT-VN-001);
