# contracts/api — External / Application API Contracts
...
The human/application-facing API contracts consumed by apps/; the only way UIs may act on the platform.
...
Accountable role: PE / ARB. Architecture owner: ARB (Architecture V2 §9); every layer has a
...
CLAUDE.md; Architecture V2; Implementation Roadmap; Architecture V2 §5.9/§6.2; RB-23 · DOC.
