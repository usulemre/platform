# contracts/domain — Domain Contracts
...
Shared domain contracts and value-object schemas expressing the ubiquitous language as stable interfaces.
...
CLAUDE.md; Architecture V2; Implementation Roadmap; CP-8; RB-26 · NAME; P1-07.
