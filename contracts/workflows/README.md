# contracts/workflows — Tier-5 Workflow Contracts
...
Artifact location for the Tier-5 workflow contracts (per CLAUDE.md Table of Authority). The governing framework is docs/contracts/workflow_contracts.md.
...
Accountable role: HSRE / ARB. Architecture owner: ARB (Architecture V2 §9); every layer has a
...
CLAUDE.md; Architecture V2; Implementation Roadmap; Workflow Contracts (Tier-5); WCON-1..3.
