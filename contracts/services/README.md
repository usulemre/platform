# contracts/services — Service Contracts
...
Service-to-service (bounded-context) contracts; the decomposed contract waist that MUST NOT re-monolithize.
...
Accountable role: ARB. Architecture owner: ARB (Architecture V2 §9); every layer has a
...
CLAUDE.md; Architecture V2; Implementation Roadmap; SE-2/3; P5-02; Architecture V2 §5.10.
