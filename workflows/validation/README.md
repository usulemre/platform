...
Orchestrate the deterministic validation gauntlet, one-shot holdout, replication, and the scientific gate that issues capital-eligibility tokens.
...
validation-service; the Trial Ledger. Dependencies flow inward toward stable contracts only (IMP-12, AV2-13); direct
cross-layer access to internals and circular dependencies are PROHIBITED.

## Related Governance Documents

CLAUDE.md; Architecture V2; Implementation Roadmap; Workflow Contracts (WFC-46); P2-05..09.
