# Portfolio Construction Workflow (WFC-48)
...
Orchestrate deterministic, net-of-cost portfolio construction from eligible alphas within risk limits.
...
Accountable role: HPR. Architecture owner: ARB (Architecture V2 §9); every layer has a
...
portfolio-service; risk-service. Dependencies flow inward toward stable contracts only (IMP-12, AV2-13); direct
cross-layer access to internals and circular dependencies are PROHIBITED.

## Related Governance Documents

CLAUDE.md; Architecture V2; Implementation Roadmap; Workflow Contracts (WFC-48); RB-12 · PORT.
