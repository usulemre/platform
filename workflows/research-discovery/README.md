# Research Discovery Workflow (WFC-43)
...
Orchestrate the idea-to-registered-hypothesis stages, gating each transition on its owning deterministic gate or human approval.
...
packages/workflow-engine; research-service; research-discovery agents. Dependencies flow inward toward stable contracts only (IMP-12, AV2-13); direct
cross-layer access to internals and circular dependencies are PROHIBITED.

## Related Governance Documents

CLAUDE.md; Architecture V2; Implementation Roadmap; Workflow Contracts (WFC-43); RB-02 · RMET.
