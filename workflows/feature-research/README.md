# Feature Research Workflow (WFC-44)
...
Orchestrate feature definition through the Leakage Harness and acceptance gates.
...
feature-service; the Leakage Harness. Dependencies flow inward toward stable contracts only (IMP-12, AV2-13); direct
cross-layer access to internals and circular dependencies are PROHIBITED.

## Related Governance Documents

CLAUDE.md; Architecture V2; Implementation Roadmap; Workflow Contracts (WFC-44); P1-06, P2-03.
