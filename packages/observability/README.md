...
Metrics, tracing, run-ledger, and per-idea/experiment/agent cost-attribution primitives.
...
logging. Dependencies flow inward toward stable contracts only (IMP-12, AV2-13); direct
cross-layer access to internals and circular dependencies are PROHIBITED.

## Related Governance Documents

CLAUDE.md; Architecture V2; Implementation Roadmap; P5-06; P1-02; OB-1..4.
