...
Define the AdministrationController interface and the administration admin route hierarchy: the administrative API surface for administration, delegating to the administration administrative application service.
...
core (AdminRequest/AdminResponse); routing (RouteDefinition); delegates to the administration administrative application service; composed via the admin pipeline.
