...
Define the PermissionAdminController interface and the permissions admin route hierarchy: the administrative API surface for permissions, delegating to the permissions administrative application service.
...
core (AdminRequest/AdminResponse); routing (RouteDefinition); delegates to the permissions administrative application service; composed via the admin pipeline.
