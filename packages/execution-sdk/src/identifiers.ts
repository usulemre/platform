/**
 * Pure Execution Simulator identifier + version primitives. Deterministic, no IO. Back
 * the registration, versioning and discovery capabilities — no execution algorithm, no
 * fill/price calculation.
 */

/** Canonical fully-qualified session key: `namespace/family/name`. */
export function sessionKey(namespace: string, family: string, name: string): string {
