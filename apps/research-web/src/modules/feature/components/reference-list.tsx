...
/**
 * Shared reference list used by Dependencies, Dataset lineage sources and Usage.
 * References with an `href` link out; those without (e.g. Signal refs, whose
 * module does not exist yet) render as plain text.
 */
