...
import { usePortfolioSummary } from '../hooks/use-portfolios';
...
/** Portfolio dashboard — advisory notice, headline counts and status
            ...
            <div className="flex flex-wrap items-center gap-2">
              {data.byStatus.map((bucket) => (
                <span key={bucket.value} className="inline-flex items-center gap-1">
                  <PortfolioStatusBadge label={bucket.label} tone={bucket.tone} />
