/**
 * Deterministic synthetic OHLCV datasets for the UI (mock DATA, not mock generation). Seeded
 * mulberry32 PRNG — no Math.random — so results are reproducible. The Signal Calculation Engine's
 * REAL SDK generators run over these bars. Refs/seeds match the Feature Calculation Engine.
 */
import { toOhlcvSeries, type OhlcvSeries } from '@platform/signal-calculation-sdk';
