/**
 * Signal view models — UI-facing, pre-formatted shapes produced by the mappers
...
export interface QualityIndicatorVm {
  readonly key: string;
  readonly label: string;
  readonly value: string;
...
export interface SignalVersionVm {
  readonly version: string;
...
export interface SignalListItemVm {
  readonly id: string;
...
export interface SignalRegistryVm {
...
export interface SignalDetailVm {
  ...
  readonly registry: SignalRegistryVm;
  readonly validation: ValidationVm;
  readonly quality: readonly QualityIndicatorVm[];
  readonly dependsOnFeatures: readonly ReferenceVm[];
  readonly strategyRefs: readonly ReferenceVm[];
  readonly experimentRefs: readonly ReferenceVm[];
  readonly versions: readonly SignalVersionVm[];
...
export interface SignalSummaryVm {
