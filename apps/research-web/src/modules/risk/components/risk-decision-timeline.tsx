...
/** Risk decision timeline (registration → review → decision/escalation). */
export function RiskDecisionTimeline({ steps }: { steps: readonly TimelineStepVm[] }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Risk decision timeline</CardTitle>
      </CardHeader>
      <CardContent>
