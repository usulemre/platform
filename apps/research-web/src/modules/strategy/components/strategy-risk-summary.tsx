 ...
 * statuses are PRE-ASSESSED upstream against governed limits; this component
 * only displays them (no risk computation, no optimization).
 */
export function StrategyRiskSummary({ risk }: { risk: readonly RiskIndicatorVm[] }) {
  return (
    <Card>
      <CardHeader>
            ...
            {risk.map((indicator) => (
              ...
              >
                ...
                <span className="flex items-center gap-2">
                  ...
                  <StrategyStatusBadge label={indicator.statusLabel} tone={indicator.tone} />
                </span>
              </li>
            ))}
          </ul>
