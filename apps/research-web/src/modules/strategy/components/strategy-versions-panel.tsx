...
import type { StrategyVersionVm } from '../domain/view-model';

/** Strategy versioning panel (immutable, versioned releases). */
export function StrategyVersionsPanel({ versions }: { versions: readonly StrategyVersionVm[] }) {
  return (
    <Card>
      <CardHeader>
